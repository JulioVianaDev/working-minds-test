...
function ButtonTop() {
  ...
  return (
    <div className=' w-nav-top h-button-content flex justify-end items-center pr-8' >
      <div onClick={()=>{setDashboardPage(NEW_VACANTY_TYPE);setTextNavTop('New Vacanty')}} className='hover:cursor-pointer rounded-buttonTop flex items-center text-white bg-purple px-padding-button-sides py-padding-button-top'>ADD NEW
